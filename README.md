Welcome to my kOS github. This is a collection of scripts intended to be used in the game Kerbal Space Program.
...
-Planning on doing further trajectory optimization to 
